...
var count=0;
var rotate=0;
var target = Math.floor(Math.PI*Math.pow(sphereradius,3)*4/6)*1000;
var life=10;
var lines;
...
function init() {
    ...
    */
    ...
    document.getElementById("targets").innerHTML = "Reach "+ target.toString() +" to the next level";
    rotate=0;
...
$("#nextlevel").click(function(){
    ...
    target = target+Math.floor(Math.PI*Math.pow(sphereradius,3)*4/6)*1000;
    changeradius();
    document.getElementById("nextlevel").style.visibility="hidden";
    document.getElementById("targets").innerHTML = "Reach "+ target.toString() +" to the next level";
